<template>
	<section class="browse-history"><a href="/mine/index.html#/history" class="title">
			<!-- react-text: 156 -->浏览历史
			<!-- /react-text --><span class="right"><span>查看全部</span><span class="SVGInline"><svg class="SVGInline-svg" style="width: 0.6rem;height: 0.6rem;"
